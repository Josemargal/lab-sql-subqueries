...
-- Paso 1: Encontrar el actor más prolífico
SELECT actor_id
FROM film_actor
GROUP BY actor_id
...
-- Paso 2: Usar ese actor_id para encontrar las películas
SELECT f.title
FROM film f
...
-- Paso 1: Encontrar al cliente más rentable
SELECT customer_id
FROM payment
...
-- Paso 2: Usar ese customer_id para encontrar las películas que ha rentado
SELECT f.title
FROM film f
